...
from lib_main.evaluation.generate_mesh import libmcubes
#from im2mesh.common import make_3d_grid
from lib_main.evaluation.generate_mesh.libsimplify import simplify_mesh
from lib_main.evaluation.generate_mesh.libmise import MISE
...
class Generator3D(object):
    ...
    def generate_mesh(self, data, return_stats=True):
        ...
        t0 = time.time()
        with torch.no_grad():
            c = self.model.point_encoder(inputs)
    ...
    def eval_points(self, p, c=None, **kwargs):
        ...
        for pi in p_split:
            ...
            with torch.no_grad():
                input = {'x_occ':pi}
                occ_hat = torch.logit(self.model.field_decoder(input, c, field='occ')['occ'])
